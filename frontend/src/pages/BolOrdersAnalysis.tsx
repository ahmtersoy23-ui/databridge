...
const RANGES = [7, 30, 90];   // Bol max 90 gun

export default function BolOrdersAnalysis() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios.get('/api/v1/bol/orders/analysis', { params: { days, account: selectedAccount } })
      .then(r => {
        setRows(r.data.data || []);
  ...
  return (
    <div>
      <h1 className="mb-4">Bol Orders Analysis</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm mb-4">
        {loading ? (
          ...
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              {filtered.map(r => (
                <tr key={r.sku ?? '_'} className="border-b border-slate-100">
