...
export const FBM_QTY_DIGEST_CRON = '0 6 * * *';     // Günlük 06:00 UTC: son 24s 0'a düşüş özeti → Slack (geçici, ~2026-06-24).
...
export const SYNC_SB_ADS_CRON = '0 22 * * *';         // Daily at 22:00 UTC (= 01:00 TR) — Amazon Ads API quieter at night, report generation ~10x faster
export const SYNC_SD_ADS_CRON = '45 22 * * *';        // Daily at 22:45 UTC (= 01:45 TR) — after SB completes
export const DATA_QUALITY_CRON = '0 8 * * *';          // Daily at 08:00 UTC (after SP ads 06:00 + business_report 07:00; SB/SD ran night before)
...
// ManuMaestro buradan okuyup stok teyidi + onay yapar. Excel pending sync'ten ayrı, sık.
// Hafif (yalnız açık siparişler, tek sayfalı GET + upsert) → 5 dk güvenli; 429 görülürse geri çek.
export const SYNC_WISERSELL_ROUTING_POLL_CRON = '*/5 * * * *';   // her 5 dk
